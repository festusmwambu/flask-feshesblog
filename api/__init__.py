"""
Welcome to the documentation for the Feshesblog API!
...
[project's source code](https://github.com/festusmwambu/Feshesblog-api) using
the [APIFairy](https://github.com/miguelgrinberg/apifairy) Flask extension.

## Introduction

Feshesblog-API is an easy to use web API for creating blogs. It is an ideal
...
Feshesblog API provides all the base features required to implement a blog project:
...
If you are running Feshesblog API yourself while developing your front end,
...
| `MAIL_SERVER` | `smtp.sendgrid.net` | The mail server to use for sending emails. |
| `MAIL_PORT` | `587` | The port to use for sending emails. |
...
| `MAIL_DEFAULT_SENDER` | `donotreply@feshesblog.sendgrid.com` | The default sender to use for emails. |
