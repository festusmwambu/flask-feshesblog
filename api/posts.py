...
@bp_posts.route('/posts/<int:id>', methods=['GET'])
@authenticate(token_auth)
...
@bp_posts.route('/users/<int:id>/posts', methods=['GET'])
@authenticate(token_auth)
@paginated_response(posts_schema, order_by=Post.timestamp,
                    order_direction='desc',
                    pagination_schema=DateTimePaginationSchema)
...
@bp_posts.route('/posts/<int:id>', methods=['PUT'])
@authenticate(token_auth)
...
@bp_posts.route('/posts/<int:id>', methods=['DELETE'])
@authenticate(token_auth)
...
@bp_posts.route('/feed', methods=['GET'])
@authenticate(token_auth)
@paginated_response(posts_schema, order_by=Post.timestamp,
                    order_direction='desc',
                    pagination_schema=DateTimePaginationSchema)
